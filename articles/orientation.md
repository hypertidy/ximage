...
reading, of `par(mfrow)`, and of every image format and spatial data
reader (GDAL, PNG, JPEG, satellite scan lines).
...
Everything else in this vignette is a demonstration of why those two
