...
- flat vector data - a hueristic is applied to make a guess, with alternatives to consider - helpful for recovering from missing metadata
...
We can call on other packages to provide input, such as `extent_from_cell` in vaster:
