...
there are matching adornment functions that share its layout
conventions:
[`xcontour()`](https://hypertidy.github.io/ximage/reference/xcontour.md)
(contours at cell centres),
[`xtext()`](https://hypertidy.github.io/ximage/reference/xtext.md) (cell
values as labels), and
[`xrect()`](https://hypertidy.github.io/ximage/reference/xrect.md)
(rectangles from extents).
...
![](reference/figures/README-imagery-1.png)
...
![](reference/figures/README-imagery-2.png)
...
![](reference/figures/README-rect1-1.png)
